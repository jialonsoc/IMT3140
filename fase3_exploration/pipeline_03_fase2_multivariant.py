...
Outputs:
    data/results_fase2_windows_clean.csv
    data/results_fase2_windows_clean_coefficients.json
"""
...
RESULTS_OUTPUT_PATH = Path("data/results_fase2_windows_clean.csv")
COEFFICIENTS_OUTPUT_PATH = Path("data/results_fase2_windows_clean_coefficients.json")
RANDOM_STATE = 42
