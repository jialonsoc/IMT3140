...
Final output:
    data/final_comparative_report.csv
"""
...
IMPORTANCE_OUTPUT_PATH = Path("data/fase3_exploration_feature_importance.csv")
IMPORTANCE_FIG_PATH = Path("reports/fase3_exploration_feature_importance.png")
FASE2_CLEAN_PATH = Path("data/results_fase2_windows_clean.csv")
